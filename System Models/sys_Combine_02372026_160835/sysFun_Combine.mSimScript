u1 =   ;% MainTank: Inlet Mass Flow 1
u2 =   ;% MainTank: Outlet Mass Flow 1
u5 =   ;% RecirTank: Inlet Mass Flow 1
u6 =   ;% RecirTank: Outlet Mass Flow 1
u8 =   ;% CoolerLoad: Energy Applied
u12 =   ;% HeatLoad: Energy Applied
SimTEnd = 2000;
