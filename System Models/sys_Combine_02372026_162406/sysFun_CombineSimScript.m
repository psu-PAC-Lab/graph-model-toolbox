...
u2 = 1.5;% MainTank: Outlet Mass Flow 1
u5 = 1.5;% RecirTank: Inlet Mass Flow 1
...
x2_0 = 6000;  %MainTank: Tank Mass(Internal-unassigned)
x3_0 = 1;  %MainTank: Delta Tank Mass(External-Source)
x4_0 = 300;  %MainTank: Inlet Temperature(External-Source)
x5_0 = 300;  %MainTank: Tank Energy Temperature(External-Sink)
x6_0 = 300;  %TankSplit: Junction Fluid Temperature(Internal-unassigned)
x7_0 = 300;  %RecirTank: Tank Fluid Temperature(Internal-unassigned)
x8_0 = 1500;  %RecirTank: Tank Mass(Internal-unassigned)
x9_0 = 1;  %RecirTank: Delta Tank Mass(External-Source)
x10_0 = 300;  %RecirTank: Tank Energy Temperature(External-Sink)
x11_0 = 300;  %CoolerLoad: Load Temperature(Internal-unassigned)
x12_0 = 1;  %CoolerLoad: Energy Applied(External-Source)
x13_0 = 300;  %EngineSplit: Junction Fluid Temperature(Internal-unassigned)
x14_0 = 1;  %EngineSplit: Outlet_3(External-Sink)
x15_0 = 300;  %HeatLoad: Load Temperature(Internal-unassigned)
