...
FilePath = string(pwd);
FuelSystem = gmt_Graph.gmt_Combine("FuelSystem",ObjectArray,PortArray,"BuildSim",FilePath);
...
FuelSystemFin = FuelSystem.gmt_InputCommon(InputMatching,"BuildSim",FilePath);

% Plot Graph
FuelSystemFin.gmt_PlotGraph

% Generate Graph Report
FuelSystemFin.gmt_ReportFull
toc

[A, B, Z] = FuelSystemFin.gmt_ControlModel("Simplify",true,"NumSub",true);
