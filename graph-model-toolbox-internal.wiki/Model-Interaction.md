...
How to inspect, visualize, and analyze a `gmt_Graph` model object after it has been built. "model" below refers to graph model object in the MATLAB workspace. 
