...
A system model is built by combining two or more component `gmt_Graph` models using `gmt_Graph.gmt_Combine`. Components connect at shared ports, and input dependencies between them are defined afterwards with `gmt_InputCommon`.
...
## See Also
[gmt_Graph](gmt_Graph) | [gmt_Port](gmt_Port) | [Component Library](Component-Models) | [Simulating Systems](Simulating-Systems)
