...
properties (SetAccess = private)
    % Internal Meta Data - Defined Only Based On Edge Object, i.e. only an edge object must be defined to define these variables  
    ...
    % External Meta Data - Defined Based On EdgeMatrix, i.e. a graph model must be defined to define these variables  
...
methods
        ...
        function obj = gmt_GraphEdge(EdgeName,EdgeEq,varargin)
            ...
            if any(match_tmp) % There is atleast one matching variable found 
                ...
                if all(isstrempty) 
                    ...
                    % Removed 01/06/2025 this should only be required for capacitance equation 
